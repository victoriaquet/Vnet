...
namespace SNC2017.Controllers
{
    public class DomiciliosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdDomicilio,Calle,Altura,Piso,CalleLateral1,CalleLateral2,Barrio,Observaciones")] Domicilio domicilio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdDomicilio,Departamento,Calle,Altura,Piso,CalleLateral1,CalleLateral2,Barrio,Observaciones,IdLocalidad,IdProvincia,TituloDom")] Domicilio domicilio)
        {
            ViewBag.localidades = db.Localidades.ToList();
            ViewBag.provincias = db.Provincias.ToList();
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("Details", new {id=domicilio.IdDomicilio});
            }
            return View(domicilio);
        }
